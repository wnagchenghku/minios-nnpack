...
DEF_CPPFLAGS += -I $(MINIOS_ROOT)/NNPACK/deps/fp16/include

# NNPACK psimd
# DEF_CPPFLAGS += -DCPUINFO_SUPPORTED_PLATFORM=1 -DNNP_BACKEND_PSIMD=1 -DNNP_CONVOLUTION_ONLY=0 -DNNP_INFERENCE_ONLY=1 

# NNPACK AVX2
DEF_CPPFLAGS += -DCPUINFO_SUPPORTED_PLATFORM=1 -DNNP_BACKEND_X86_64=1 -DNNP_CONVOLUTION_ONLY=0 -DNNP_INFERENCE_ONLY=1 